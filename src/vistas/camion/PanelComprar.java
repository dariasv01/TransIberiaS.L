...
public class PanelComprar extends JPanel {
	...
	public PanelComprar(String nombre) {
		...
		panelMatricula.getTxtMatricula().setVisible(true);
		panelMatricula.getTxtPotencia().setVisible(true);
		panel.setLayout(new BorderLayout(0, 0));
		panelMatricula.setBackground(new Color(240, 230, 140));
	...
	public void setPanelMatricula(PanelMatricula panelMatricula) {
